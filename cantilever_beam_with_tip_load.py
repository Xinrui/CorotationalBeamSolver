...
sys.solve_the_system(solver="load-control", number_of_increments = 500, load=-1400, max_iteration_steps=10000, tolerance=0.01)
# sys.solve_the_system(solver="displacement-control", number_of_increments=50, displacement=4.4, max_iteration_steps=100)
# sys.solve_the_system(solver="arc-length-control", number_of_increments=20, direction="negative", arc_length=0.3)
time_end = time.time()
